  ...
  return (
    <div className="p-6 space-y-6 bg-background ">
      <div className="flex items-center gap-4">
        <Button className="text-white" variant="ghost" size="sm" asChild>
          <Link href="/dashboard/domains">
            <ArrowLeft className="h-4 w-4" />
          </Link>
        </Button>
        <div>
          <h1 className="text-3xl font-bold text-white">Verificar Domínio</h1>
          <p className="text-muted-foreground">Confirme a propriedade do domínio {domain.domain}</p>
        </div>
      </div>
            ...
            <CardContent>
              <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                <p className="text-sm text-green-800">
                  ✅ Seu domínio foi verificado com sucesso! Agora você pode criar links usando este domínio.
                </p>
              </div>
            </CardContent>
          )}
            ...
            {domain.verification_method === "dns" && (
              <Card className="bg-foreground border-zinc-700">
                <CardHeader>
                  ...
                  <CardDescription>Adicione o seguinte registro TXT no seu provedor de DNS</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2 p-3 bg-muted rounded-lg">
                      <code className="flex-1 text-sm break-all">{domain.verification_token}</code>
                  ...
                  <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <ol className="text-sm text-blue-800 space-y-1 list-decimal list-inside">
                      <li>Acesse o painel do seu provedor de DNS (Cloudflare, GoDaddy, etc.)</li>
            ...
            {domain.verification_method === "file" && (
              <Card className="bg-foreground border-zinc-700">
                <CardHeader>
                  ...
                  <CardDescription>Faça upload do arquivo de verificação para seu servidor</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                  ...
                  <div className="p-4 bg-background border border-zinc-700 rounded-lg">
                    ...
                    <ol className="text-sm text-zinc-300 space-y-1 list-decimal list-inside">
                      ...
                      <li>Faça upload para a pasta /.well-known/ do seu servidor</li>
                      <li>Certifique-se de que o arquivo está acessível via HTTPS</li>
                      <li>Clique em "Verificar Domínio" abaixo</li>
                    </ol>
                  </div>
                </CardContent>
            ...
            <Card className="bg-foreground border-zinc-700">
              <CardContent>
                <div className="flex w-full justify-between gap-12">
                  ...
                  <Button className="max-sm:flex-1 bg-background text-white hover:bg-background" asChild>
