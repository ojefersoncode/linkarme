        ...
        <div className="flex flex-col items-center justify-center mx-auto px-4 md:h-[400px] max-md:h-[600px]">
          <div className="text-center space-y-4">
            <div className="space-y-4">
              <h1 className="text-2xl md:text-6xl md:max-w-5xl max-md:max-w-md font-bold text-primary">
                Dashboard completa para rastreia os clicks nos seus anuncios
              </h1>
              <p className="text-lg md:text-2xl text-muted-foreground max-md:max-w-sm md:max-w-2xl mx-auto">
            ...
            <div className="flex w-full justify-center items-center py-4">
              <ShimmerButton className="shadow-2xlmax-md:w-sm">
                <span className="whitespace-pre-wrap text-center text-sm font-medium leading-none tracking-tight bg-blue-600/5 dark:bg-blue-600/5 text-muted-foreground dark:from-white dark:to-slate-900/10">
