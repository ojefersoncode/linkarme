...
export default async function CardsUse() {
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 max-md:px-4">
      <div className="bg-foreground border-foreground pl-1 rounded-2xl">
        <Card className="bg-white border-none gap-2">
          ...
          <CardContent className="pt-0">
            <div className="text-2xl font-bold text-black">{stats.domains}</div>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="bg-foreground border-foreground pl-1 rounded-2xl">
        <Card className="bg-white border-none gap-2">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-black">{stats.links}</div>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="bg-foreground border-foreground pl-1 rounded-2xl">
        <Card className="bg-white border-none gap-2">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-black">{stats.clicks}</div>
          </CardContent>
        </Card>
      </div>
