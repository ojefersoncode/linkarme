...
export function AnalyticsCharts({ clicksByDay, clicksByCountry, days }: AnalyticsChartsProps) {
  return (
    <div className="grid gap-6 md:grid-cols-2 ">
      <Card>
        <CardHeader>
          <CardTitle>Cliques ao Longo do Tempo</CardTitle>
          <CardDescription>Visualize a evolução dos cliques nos últimos {days} dias</CardDescription>
        </CardHeader>
        <CardContent>
